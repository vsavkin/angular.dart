...
class DirectiveInjector implements DirectiveBinder {
  ...
  DestinationLightDom get _destLightDom =>
      parent.lightDom;
}
...
class TranscludingComponentDirectiveInjector extends ComponentDirectiveInjector {
  TranscludingComponentDirectiveInjector(DirectiveInjector parent, Injector appInjector,
                                  EventHandler eventHandler, Scope scope, View view,
                                  templateLoader, shadowRoot, LightDom lightDom)
      : super(parent, appInjector, eventHandler, scope, view, templateLoader, shadowRoot) {
    parent.lightDom = lightDom;
  }
}
